...
const{showAllUser} =require('../controller/userController.js');
...
module.exports=router; ///node js mein hum ye explicitly mention karte hain ki vo konse module,class,object hain jo hum doosre modules ko dena chahte hain 